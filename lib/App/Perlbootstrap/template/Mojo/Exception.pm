package App::Perlbootstrap::template::Mojo::Exception;
...
sub _detect {
  ...
  return $msg if defined $msg && $msg->isa('App::Perlbootstrap::template::Mojo::Exception');
  $self->message($msg);
...
App::Perlbootstrap::template::Mojo::Exception - Exceptions with context

=head1 SYNOPSIS

  use App::Perlbootstrap::template::Mojo::Exception;

  # Throw exception
  App::Perlbootstrap::template::Mojo::Exception->throw('Not again!');

  # Customize exception
  die App::Perlbootstrap::template::Mojo::Exception->new('Not again!')->trace(2)->verbose(1);

=head1 DESCRIPTION

L<App::Perlbootstrap::template::Mojo::Exception> is a container for exceptions with context information.

=head1 ATTRIBUTES

L<App::Perlbootstrap::template::Mojo::Exception> implements the following attributes.
...
L<App::Perlbootstrap::template::Mojo::Exception> inherits all methods from L<App::Perlbootstrap::template::Mojo::Base> and implements the
following new ones.

=head2 new

  my $e = App::Perlbootstrap::template::Mojo::Exception->new('Oops!');
  my $e = App::Perlbootstrap::template::Mojo::Exception->new('Oops!', $files);

Construct a new L<App::Perlbootstrap::template::Mojo::Exception> object.

=head2 throw

  App::Perlbootstrap::template::Mojo::Exception->throw('Oops!');
  App::Perlbootstrap::template::Mojo::Exception->throw('Oops!', $files);
...
L<App::Perlbootstrap::template::Mojo::Exception> overloads the following operators.
...
L<App::Perlbootstrap::template::Mojo>, L<Mojo::Base>.
