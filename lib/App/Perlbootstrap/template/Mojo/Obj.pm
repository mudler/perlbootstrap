...
sub attr {
    ...
    for my $attr ( @{ ref $attrs eq 'ARRAY' ? $attrs : [$attrs] } ) {
        ...
        warn "-- Attribute $attr in $class\n$code\n\n"
            if $ENV{App::Perlbootstrap::template::Mojo_OBJ_DEBUG};
        die "App::Perlbootstrap::template::Mojo::Obj error: $@" unless eval "$code;1";
    }
}
...
App::Perlbootstrap::template::Mojo::Obj - Minimal base class for App::Perlbootstrap::template::Mojo
...
=head1 SYNOPSIS
  ...
  package Tiger;
  use App::Perlbootstrap::template::Mojo::Obj 'Cat';
...
L<App::Perlbootstrap::template::Mojo::Obj> is a simple base class for L<App::Perlbootstrap::template::Mojo>, a fork of  L<Mojo::Base>.

  # Automatically enables "strict", "warnings", "utf8" and Perl 5.10 features
  use App::Perlbootstrap::template::Mojo::Obj -strict;
  use App::Perlbootstrap::template::Mojo::Obj -base;
  use App::Perlbootstrap::template::Mojo::Obj 'SomeBaseClass';
...
All three forms save a lot of typing.
  ...
  use feature ':5.10';
  use IO::Handle ();
  use App::Perlbootstrap::template::Mojo::Obj;
  push @ISA, 'App::Perlbootstrap::template::Mojo::Obj';
  sub has { App::Perlbootstrap::template::Mojo::Obj::attr(__PACKAGE__, @_) }
...
L<App::Perlbootstrap::template::Mojo::Obj> implements the following functions like L<Mojo::Base>, which can be imported with
...
L<App::Perlbootstrap::template::Mojo::Obj> implements the following methods.
...
You can set the C<App::Perlbootstrap::template::Mojo_OBJ_DEBUG> environment variable to get some advanced
diagnostics information printed to C<STDERR>.

  App::Perlbootstrap::template::Mojo_OBJ_DEBUG=1
