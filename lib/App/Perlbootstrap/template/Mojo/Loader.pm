...
use App::Perlbootstrap::template::Mojo::Util qw(b64_decode class_to_path);
...
sub load {
  ...
  # Real error
  return App::Perlbootstrap::template::Mojo::Exception->new($@);
}
...
App::Perlbootstrap::template::Mojo::Loader - Loader

=head1 SYNOPSIS

  use App::Perlbootstrap::template::Mojo::Loader;

  # Find modules in a namespace
  my $loader = App::Perlbootstrap::template::Mojo::Loader->new;
...
L<App::Perlbootstrap::template::Mojo::Loader> is a class loader and plugin framework.

=head1 METHODS

L<App::Perlbootstrap::template::Mojo::Loader> inherits all methods from L<App::Perlbootstrap::template::Mojo::Base> and implements the
following new ones.
...
L<App::Perlbootstrap::template::Mojo::Obj>, L<Mojo::Base>.
